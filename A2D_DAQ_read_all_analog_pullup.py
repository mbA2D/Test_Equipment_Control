...
def gather_and_write_data(filepath, timestamp, print_all=True, print_max = False):
    daq.set_led(1)
    ...
    FileIO.write_line_csv(filepath, data)
...
if __name__ == '__main__':
    ...
    daq.config_dict = AD_control.A2D_DAQ_config.get_config_dict()
    daq.configure_from_dict()
    ...
    while True:
        try:
            gather_and_write_data(path, timestamp=time.time())
